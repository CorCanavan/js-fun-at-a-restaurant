...
console.log("variables", food, type, inStock);
...
console.log("stock doubled", inStock);
...
console.log("stock reduced", inStock);
...
console.log("OrderMore", shouldOrderMore);
...
var vegetables = ["broccoli", "kale", "spinach", "carrots", "celery"];
...
// different fruits.
var fruits = ["blackberries", "strawberries", "apples", "grapes", "oranges", "bananas", "mango"];
...
groceryStore.location = "1155 E 9th Ave, Denver, CO 80218"
console.log(groceryStore);
